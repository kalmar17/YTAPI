...
class CrawlerChannels(key: String, channelIds: Array[String],
  ...
  private val part: String = channelParts.getOrElse("contentDetails,snippet,brandingSettings,contentOwnerDetails,localizations,statistics,status,topicDetails")
  ...
  def getChannelListRequest: ChannelListResponse = {
